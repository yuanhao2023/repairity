#!/usr/bin/env python3
# train_binary_reward_model.py - Train a binary reward model for code quality
...
def parse_args():
    ...
    parser.add_argument("--model_name", default="google/codegemma-2b", 
                      help="Base model to use (default: google/codegemma-2b)")
    parser.add_argument("--feedback_file", required=True,
                      help="Path to binary feedback JSON file")
